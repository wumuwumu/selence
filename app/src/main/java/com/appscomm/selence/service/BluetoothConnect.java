...
//
//
//    private static BluetoothConnect bluetoothConnect = new BluetoothConnect();
...
//        public BluetoothConnect getService() {
...
//                BluetoothConnect.this.name = scanResult.getDevice().getName();
//                BluetoothConnect.this.mac = scanResult.getDevice().getAddress();
//            }
//
//            @Override
...
//                BluetoothConnect.this.gatt = gatt;
//                runOnMainThread(new Runnable() {
//                    @Override
//                    public void run() {
//                        if (mCallback != null) {
...
//        }
//
//        bleManager.scanfuzzyNameAndConnect(name, 10000, false, new BleGattCallback() {
//
//            @Override
//            public void onFoundDevice(ScanResult scanResult) {
//                runOnMainThread(new Runnable() {
