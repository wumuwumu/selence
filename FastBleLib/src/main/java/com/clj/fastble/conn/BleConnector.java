...
public class BleConnector {
     ...
     * write
     */
    public boolean writeCharacteristic2(String data, BleCharacterCallback bleCallback, String uuid_write) {
        if (data == null) {
//            if (bleCallback != null) {
...
//                bleCallback.onInitiatedResult(false);
        ...
        getCharacteristic().setValue(data);
//        isSendSuccess = getBluetoothGatt().writeCharacteristic(getCharacteristic());
        return handleAfterInitialed(getBluetoothGatt().writeCharacteristic(getCharacteristic()), bleCallback);
    }
