...
public abstract class CalendarPager extends ViewPager {
    ...
    public CalendarPager(Context context, AttributeSet attrs) {
        ...
        Attrs.redColor = ta.getColor(R.styleable.NCalendar_redColor, getResources().getColor(R.color.redColor));
        Attrs.blueColor = ta.getColor(R.styleable.NCalendar_blueColor, getResources().getColor(R.color.blueColor));
        Attrs.blue2Color = ta.getColor(R.styleable.NCalendar_blueColor, getResources().getColor(R.color.blue2Color));
