...
public abstract class CalendarView extends View {
    ...
    protected Paint mRedPaint;      //画姨妈日期
    protected Paint mBluePaint;
    protected Paint mBlue2Paint;

    protected int mSelectCircleRadius;//选中圆的半径
    protected int mSelectCircleColor;//选中圆的颜色
    protected boolean isShowLunar;//是否显示农历

    protected int mSelectCircleRedColor;//姨妈圆的颜色
    protected int mSelectCircleBlueColor;//排卵圆的颜色
    protected int mSelectCircleBlue2Color;//排卵日的颜色
    ...
    public CalendarView(Context context) {
        ...
        mSelectCircleRedColor = Attrs.redColor;
        mSelectCircleBlueColor = Attrs.blueColor;
        mSelectCircleBlue2Color = Attrs.blue2Color;
        ...
        mRedPaint = getPaint(mSelectCircleRedColor, mSolarTextSize);
        mBluePaint = getPaint(mSelectCircleBlueColor, mSolarTextSize);
        mBlue2Paint = getPaint(mSelectCircleBlue2Color, mSolarTextSize);
